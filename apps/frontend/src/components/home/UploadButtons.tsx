...
type TUploadModalOptions = typeof UploadModalityType[keyof typeof UploadModalityType];

const UploadButtons = () => {
    const [activeFileTypeOption, setActiveFileTypeOption] = useState<TUploadDataOptions>(UploadDataType.BDIS);
    const [activeModalityTypeOption, setActiveModalityTypeOption] = useState<TUploadModalOptions>(UploadModalityType.ASL);
    ...
    return (
        <div className={"flex items-center justify-between mb-4"}>
            ...
            <div>
                ...
                />
                <Button className={"cursor-pointer"} onClick={handleUploadClick} aria-label={`Upload ${activeModalityTypeOption} ${activeFileTypeOption} files`}>
                    <UploadIcon/>
